...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="col">
            <div class="alert alert-light alert-elevate fade show" role="alert">
                ...
                <div class="alert-text">
                    Please Note that you cant add new region name that is used before <br>
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="post" action="{{ route('region.update',$region->id)}}">
            @method('patch')

            @csrf
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <label class="col-form-label col-lg-3 col-sm-12">region name</label>
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input type="text" name="name" class="form-control" value="{{$region->name}}"
                            placeholder="please enter your region name">
                    </div>
                </div>
                <div class="form-group row">
