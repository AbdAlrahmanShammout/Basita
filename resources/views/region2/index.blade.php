            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{route('region.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <table class="table table-striped table-hover table-checkable" id="kt_table_1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->id}}</td>
                        <td nowrap>
                            <a href="{{route('region.show',$item->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                                <i class="la la-eye"></i>
                            </a>
